...
public class BinaryCodeTest {
	...
	public void test6() {
		String message = "22";
		assertArrayEquals(new String[] { "NONE", "11"}, new BinaryCode().decode(message));
	}

    @Test
	public void test7() {
		String message = "2222221";
		assertArrayEquals(new String[] { "NONE", "1101101"}, new BinaryCode().decode(message));
	}
    @Test
	public void test8() {
		String message = "1";
		assertArrayEquals(new String[] { "NONE", "1"}, new BinaryCode().decode(message));
	}
    @Test
	public void test9() {
		String message = "0";
		assertArrayEquals(new String[] { "0", "NONE"}, new BinaryCode().decode(message));
	}
}
